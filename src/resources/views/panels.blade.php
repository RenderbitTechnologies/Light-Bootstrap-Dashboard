                    ...
                    <div class="card-body">
                        <ul role="tablist" class="nav nav-tabs">
                            <li role="presentation" class="nav-item">
                                <a class="nav-link show active" id="info-tab" href="#agency" data-toggle="tab">Info</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body content-full-width">
                        <ul role="tablist" class="nav nav-tabs">
                            <li role="presentation" class="nav-item">
                                <a class="nav-link show active" id="info-tab" href="#icon-info" data-toggle="tab"><i class="fa fa-info"></i> Info</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-md-8 ml-auto mr-auto">
                ...
                <div class="nav-container">
                    <ul class="nav nav-icons justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link show active" id="description-tab" href="#description-logo" role="tab" data-toggle="tab">
