                    ...
                    <div class="card-body table-full-width">
                        <table class="table table-bigboy">
                            ...
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="{{ asset('vendor/lbd/img/blog-1.jpg') }}" alt="...">
                                    </div>
                                </td>
                                <td class="td-name">
                            ...
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="{{ asset('vendor/lbd/img/blog-2.jpg') }}" alt="...">
                                    </div>
                                </td>
                                <td class="td-name">
                            ...
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="{{ asset('vendor/lbd/img/blog-3.jpg') }}" alt="...">
                                    </div>
                                </td>
                                <td class="td-name">
                            ...
                            <tr>
                                <td>
                                    <div class="img-container">
                                        <img src="{{ asset('vendor/lbd/img/blog-4.jpg') }}" alt="...">
                                    </div>
                                </td>
                                <td class="td-name">
